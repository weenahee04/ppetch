...
export const Dashboard: React.FC<DashboardProps> = ({ username, onLogout, onNavigate }) => {
  ...
  const renderIcon = (name: string) => {
      switch(name) {
          ...
          case 'list': return <svg className="w-8 h-8 text-[#b08528]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd"></path></svg>;
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
                <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl border-2 border-[#b08528] relative">
                    ...
                    <div className="bg-gradient-to-r from-[#eebf34] to-[#b08528] p-6 text-center">
                        <h2 className="text-2xl font-bold text-white mb-1 drop-shadow-md">🔮 บ้านหวย AI</h2>
